...
export const enhancePrompt = async (userPrompt: string, apiKey: string, svgCode?: string): Promise<GeminiResponse> => {
  try {
    ...
    throw new Error(`خطا در ارتباط با Gemini API: ${errorMessage}`);
  }
};